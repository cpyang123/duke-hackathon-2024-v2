...
label_filter = st.sidebar.selectbox(
    "Node Label Filter",
    options=["AFFILIATION", "APPOINTMENT TITLE", "DEGREE", "DEPARTMENT", "ORGANIZATION", "RESEARCH INTERESTS", "DUKE UNIQUE ID"]
)
relationship_filter = st.sidebar.selectbox(
    "Relationship Type Filter",
    options=["academic affiliation", "research role", "faculty appointment"]  # Add other relationship types as needed
)
